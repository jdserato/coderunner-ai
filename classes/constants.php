...
class constants {
    ...
    const GENAI_ARITHMETIC = 0;
    const GENAI_SELECTION = 1;
    const GENAI_ITERATIVE = 2;
    ...
    const CHATGPT_DEFAULT_API_KEY = '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';
