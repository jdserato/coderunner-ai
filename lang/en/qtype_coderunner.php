...
$string['generateAIoptions'] = 'AI Question Generator';
$string['generateAI'] = 'Generate Question via AI';
$string['generateAI_help'] = 'Let OpenAI fill out the question details based on the chosen question category';
$string['generateAI_button'] = 'Generate';
...
$string['genai_arithmetic'] = 'Arithmetic';
$string['genai_selection'] = 'Selection';
$string['genai_iterative'] = 'Iterative';
...
$string['chatgpt_apikey'] = 'ChatGPT API-key';
$string['chatgpt_apikey_desc'] = 'The API key to be included in all ChatGPT requests';
