...
$settings->add(new admin_setting_configtext(
        "qtype_coderunner/chatgpt_apikey",
        get_string('chatgpt_apikey', 'qtype_coderunner'),
        get_string('chatgpt_apikey_desc', 'qtype_coderunner'),
        constants::CHATGPT_DEFAULT_API_KEY));
